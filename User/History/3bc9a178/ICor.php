...
class Base {
    ...
    public function getConfig(){
        if(!file_exists(filename:_DIR_ . '../../../config/autoload/local.php')){

            return include _DIR_ . '../../../config/autoload/global.php';
        }
        return include _DIR_ .  '../../../config/autoload/local.php'
    }
    ...
    public function setOrder(&$select){
        if(!empty($this->params['order'])){
            ...
            $select->limit($this->params['order']);
